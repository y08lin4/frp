            ...
            <div class="header-info">
              ...
              <div class="header-meta">
                ...
                <span v-if="proxy.lastStartTime" class="meta-text">
                  ...
                  {{ $t('proxyDetail.lastStarted', { time: proxy.lastStartTime }) }}
                </span>
                <span v-if="proxy.lastCloseTime" class="meta-text">
                  <span class="meta-sep">·</span>
                  {{ $t('proxyDetail.lastClosed', { time: proxy.lastCloseTime }) }}
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="config-grid">
            <div class="config-item-card">
              ...
              <div class="config-item-content">
                ...
                <span class="config-item-value">{{
                  proxy.encryption ? $t('proxyDetail.enabled') : $t('proxyDetail.disabled')
                }}</span>
              </div>
            </div>
            ...
            <div class="config-item-card">
              ...
              <div class="config-item-content">
                ...
                <span class="config-item-value">{{
                  proxy.compression ? $t('proxyDetail.enabled') : $t('proxyDetail.disabled')
                }}</span>
              </div>
            </div>
